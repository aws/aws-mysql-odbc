...
```bash
[ODBC Data Sources]
data_source_name = AWSODBCDriverDSN

[AWSODBCDriverDSN]
Driver          = AWSODBCDriver
DESCRIPTION     = AWS ODBC ANSI Driver for MySQL
```

##### odbcinst.ini
```bash
[ODBC Drivers]
AWSODBCDriver = Installed

[AWSODBCDriver]
Driver        = /Library/ODBC/AWS_MySQL_ODBC_Connector/bin/awsmysqlodbca.dylib
Description   = AWS ODBC ANSI Driver for connecting to a MySQL database server
```
