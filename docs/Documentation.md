...
- [Using the AWS ODBC Driver for MySQL](./using-the-aws-driver/UsingTheAwsDriver.md)
    ...
    - [AWS Authentication](./using-the-aws-driver/AwsAuthentication.md)
        ...
        - [ADFS Authentication](./using-the-aws-driver/ADFSAuthentication.md)
            - [How to use ADFS authentication](./using-the-aws-driver/ADFSAuthentication.md#how-to-use-adfs-authentication)
        - [Okta Authentication](./using-the-aws-driver/OktaAuthentication.md)
            - [How to use Okta authentication](./using-the-aws-driver/OktaAuthentication.md#how-to-use-okta-authentication)
