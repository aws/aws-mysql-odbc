...
SECRETS_MANAGER_PROXY::SECRETS_MANAGER_PROXY(DBC* dbc, DataSource* ds, CONNECTION_PROXY* next_proxy) : CONNECTION_PROXY(dbc, ds) {
...
void SECRETS_MANAGER_PROXY::set_next_proxy(CONNECTION_PROXY* next_proxy) {
